document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateVideo(item) {
        ...
        currentVideo.src = `${videoUrl}?autoplay=1&rel=0`;  // Fix: string interpolation
    ...
    function unlockNextVideo() {
        ...
        const nextVideo = activeVideo ? activeVideo.nextElementSibling : null;
    ...
    document.querySelectorAll(".quiz-btn").forEach((button) => {
        button.addEventListener("click", (e) => {
            ...
            // Ambil pertanyaan
            const question = quizContainer.querySelector("#quiz-question").textContent;
            ...
            const isCorrect = correctAnswers.some((answer) => userAnswer === answer);  // Fix: exact match
    ...
    //         window.location.href = "/certificates/your-certificate.pdf"; 
    //     }
    // });
});
