...
<div class="py-8 px-4 md:px-12 mx-auto max-w-7xl">
    <form action="{{ route('mentor.mycourse.update', $course->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" id="description" rows="1" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $course->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="sub_description" id="sub_description" rows="2" 
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('sub_description', $course->sub_description) }}</textarea>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="material_title" id="material_title" value="{{ old('material_title', $course->material_title) }}"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <textarea name="material_description" id="material_description" rows="3"
                        class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('material_description', $course->material_description) }}</textarea>
